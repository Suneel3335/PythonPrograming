...
var1=DoubleVar()
var2=DoubleVar()
label=Label(root, text='TEMPRETURE CONVERTIR', font=('Arial',30))
label.pack(side=TOP)

label1=Label(root,text='Temperature in Celcius =',font=('Arial',25))
...
label4=Label(root,text='Temperature in Ferenheit =',font=('Arial',25))
label4.place(x=200,y=400)

label5=Label(root,text='Temperature in Celcius =',font=('Arial',25))
